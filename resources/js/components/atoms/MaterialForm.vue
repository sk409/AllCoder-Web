    ...
    <div class="row">
      <div class="col-7">
        <div class="shadow p-3">
          <form method="post" enctype="multipart/form-data" :action="action">
            ...
            <div class>
              <label class="material-form-label">
                <span class="material-form-label-text">サムネイル画像:</span>
                <input class="material-form-control" type="file" name="thumbnail_image" />
              </label>
            </div>
      ...
      <div class="offset-1 col-4">
        <div class="shadow p-3">
          ...
          <selected-lessons :lessons="material.user.lessons" :selected-ids="selectedLessonIds"></selected-lessons>
        </div>
      </div>
    </div>
  </div>
...
<script>
import SelectedLessons from "./MaterialFormSelectedLessons.vue";
export default {
  name: "material-form",
  props: {
    material: Object,

...
/***/ "./resources/js/chat_room_show.js":
/*!****************************************!*\
  !*** ./resources/js/chat_room_show.js ***!
  \****************************************/
/*! no exports provided */
...
new Vue({
  ...
  methods: {
    ...
    shrinkMessageBox: function shrinkMessageBox(e) {
      var messageBox = this.$refs.messageBox;
...
/***/ "./resources/js/models/chat_message.js":
/*!*********************************************!*\
  !*** ./resources/js/models/chat_message.js ***!
  \*********************************************/
...
function (_Model) {
  ...
  _createClass(ChatMessage, null, [{
    ...
    value: function index(parameters, completion) {
      return _model_js__WEBPACK_IMPORTED_MODULE_0__["default"].index(ChatMessage.baseRoute(), parameters, completion);
    }
  }]);

  function ChatMessage(text, userId, chatRoomId) {
    var _this;

    _classCallCheck(this, ChatMessage);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ChatMessage).call(this, ChatMessage.baseRoute()));
    _this.text = text;
    _this.userId = userId;
...
/***/ 20:
/*!**********************************************!*\
  !*** multi ./resources/js/chat_room_show.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

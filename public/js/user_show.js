...
/***/ "./resources/js/models/follower.js":
/*!*****************************************!*\
  !*** ./resources/js/models/follower.js ***!
  \*****************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Follower; });
...
function (_Model) {
  ...
  _createClass(Follower, null, [{
    ...
    value: function index(parameters, completion) {
      return _model_js__WEBPACK_IMPORTED_MODULE_0__["default"].index(Follower.baseRoute(), parameters, completion);
    }
  }]);

  function Follower(followerUserId, followingUserId) {
    var _this;

    _classCallCheck(this, Follower);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Follower).call(this, Follower.baseRoute()));
    _this.followerUserId = followerUserId;
    _this.followingUserId = followingUserId;
    return _this;
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _models_follower_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/follower.js */ "./resources/js/models/follower.js");
...
new Vue({
  ...
  methods: {
    follow: function follow(e, follower_user_id, following_user_id) {
      var _this = this;

      var follower = new _models_follower_js__WEBPACK_IMPORTED_MODULE_0__["default"](follower_user_id, following_user_id);
      follower.store(function (response) {
        if (response.status === 200) {
          ...
          e.target.classList.add("is-disabled"); // e.target.parentNode.setAttribute("disabled", "disabled");
...
/***/ 18:
/*!*****************************************!*\
  !*** multi ./resources/js/user_show.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/kobayashimasato/Apps/Web/ProMark/resources/js/user_show.js */"./resources/js/user_show.js");

...
/***/ "./resources/js/dashboard_chat_rooms.js":
/*!**********************************************!*\
  !*** ./resources/js/dashboard_chat_rooms.js ***!
  \**********************************************/
/*! no exports provided */
...
/* harmony import */ var _models_invitation_request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/invitation_request */ "./resources/js/models/invitation_request.js");
/* harmony import */ var _models_chat_room__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/chat_room */ "./resources/js/models/chat_room.js");
...
new Vue({
  ...
  mounted: function mounted() {
    ...
    var chatRooms = JSON.parse(document.getElementById("__chat-rooms").textContent);
    this.user.chatRooms = chatRooms;
    var usersSentInvitationRequest = JSON.parse(document.getElementById("__users-sent-invitation-request").textContent);
    usersSentInvitationRequest.forEach(function (userSentInvitationRequest, index) {
      _this.invitationRequests[index].sender = userSentInvitationRequest;
    });
    var invitedRooms = JSON.parse(document.getElementById("__invited-rooms").textContent);
    invitedRooms.forEach(function (invitedRoom, index) {
      _this.invitationRequests[index].room = invitedRoom;
    });
  },
  methods: {
    ...
    attend: function attend(invitationRequestId, chatRoomId) {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/chat_room_user", {
        "user_id": this.user.id,
        "chat_room_id": chatRoomId
      }).then(function (response) {
        if (response.status === 200) {
          _this2.destoryInvitationRequest(invitationRequestId);

          _models_chat_room__WEBPACK_IMPORTED_MODULE_2__["default"].index({
            "id": chatRoomId
          }, function (response) {
            var chatRoom = new _models_chat_room__WEBPACK_IMPORTED_MODULE_2__["default"](response.data[0].name);
            chatRoom.id = response.data[0].id;
            chatRoom.created_at = response.data[0].created_at;

            _this2.user.chatRooms.push(chatRoom);
          });
        }
      });
    },
    destoryInvitationRequest: function destoryInvitationRequest(invitationRequestId) {
      _models_invitation_request__WEBPACK_IMPORTED_MODULE_1__["default"].index({
        "id": invitationRequestId
      }, function (response) {
        var invitationRequest = new _models_invitation_request__WEBPACK_IMPORTED_MODULE_1__["default"](response.data.sender_user_id, response.data.receiver_user_id, response.data.chat_room_id);
        invitationRequest.id = invitationRequestId;
        invitationRequest.destroy(function (response) {// console.log(response);
        });
      });
      this.invitationRequests = this.invitationRequests.filter(function (invitationRequest) {
        return invitationRequest.id !== invitationRequestId;
      });
    },
    showInvitationRequestsDialog: function showInvitationRequestsDialog() {
...
/***/ 14:
/*!****************************************************!*\
  !*** multi ./resources/js/dashboard_chat_rooms.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/kobayashimasato/Apps/Web/ProMark/resources/js/dashboard_chat_rooms.js */"./resources/js/dashboard_chat_rooms.js");

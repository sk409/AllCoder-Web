...
/***/ "./resources/js/dashboard_followings.js":
/*!**********************************************!*\
  !*** ./resources/js/dashboard_followings.js ***!
  \**********************************************/
/*! no exports provided */
...
/* harmony import */ var _models_user_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/user.js */ "./resources/js/models/user.js");
...
new Vue({
  ...
  methods: {
    ...
    showUserSearchDialog: function showUserSearchDialog() {
      this.userSearchDialog.isVisible = true;
    },
    searchUser: function searchUser() {
      var _this = this;

      _models_user_js__WEBPACK_IMPORTED_MODULE_0__["default"].index({
        name: this.userSearchDialog.username
      }, function (response) {
        _this.userSearchDialog.users = response.data;
      });
    }
  }
});
...
/***/ 12:
/*!****************************************************!*\
  !*** multi ./resources/js/dashboard_followings.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/kobayashimasato/Apps/Web/ProMark/resources/js/dashboard_followings.js */"./resources/js/dashboard_followings.js");

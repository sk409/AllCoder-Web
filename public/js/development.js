...
/* harmony import */ var _file_tree_FileTree_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./file-tree/FileTree.vue */ "./resources/js/development/file-tree/FileTree.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
      ...
      var map = function map(before, after) {
        ...
        before.children.forEach(function (beforeChild) {
          if (beforeChild.hasOwnProperty("text")) {
            after.children.push(new _models_File_js__WEBPACK_IMPORTED_MODULE_0__["default"](beforeChild.path, ""));
          } else {
            var afterChild = new _models_Folder_js__WEBPACK_IMPORTED_MODULE_2__["default"](beforeChild.path);
  ...
  methods: {
    ...
    onOpenConsoleTab: function onOpenConsoleTab(portNumber) {
      open("localhost:" + portNumber); //window.focus();
